import 'package:schop_app/models/category.dart';
import 'package:schop_app/models/item.dart';
import 'package:schop_app/models/promotion.dart';
...
class Fake {
  ...
  static List<Promotion> promotions = [
    ...
    Promotion(
      ...
      imagePath: 'assets/images/furniture/jacalyn-beales-435629-unsplash.png',
      tag: '',
    )
  ];
